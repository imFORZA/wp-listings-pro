...
global $post;
	...
	echo '<textarea name="wp_listings[_listing_featured_on]" id="" class="" rows="3" cols="18" style="width:100%;">' . htmlentities( get_post_meta( $post->ID, '_listing_featured_on', true ) ) . '</textarea>';
	...
	echo '<textarea name="wp_listings[_listing_home_sum]" id="" class="" rows="3" cols="18" style="width:100%;">' .  htmlentities( get_post_meta( $post->ID, '_listing_home_sum', true ) ) . '</textarea>';
	...
	echo '<textarea name="wp_listings[_listing_kitchen_sum]" id="" class="" rows="3" cols="18" style="width:100%;">' . htmlentities( get_post_meta( $post->ID, '_listing_kitchen_sum', true ) ) . '</textarea>';
	...
	echo '<textarea name="wp_listings[_listing_living_room]" id="" class="" rows="3" cols="18" style="width:100%;">' . htmlentities( get_post_meta( $post->ID, '_listing_living_room', true ) ) . '</textarea>';
	...
	echo '<textarea name="wp_listings[_listing_master_suite]" id="" class="" rows="3" cols="18" style="width:100%;">' . htmlentities( get_post_meta( $post->ID, '_listing_master_suite', true ) ) . '</textarea>';
	...
	echo '<textarea name="wp_listings[_listing_school_neighborhood]" id="" class="" rows="3" cols="18" style="width:100%;">' . htmlentities( get_post_meta( $post->ID, '_listing_school_neighborhood', true ) ) . '</textarea>';
	...
	echo '<textarea name="wp_listings[_listing_disclaimer]" id="" class="" rows="3" cols="18" style="width:100%;">' . htmlentities( get_post_meta( $post->ID, '_listing_disclaimer', true ) ) . '</textarea>';
