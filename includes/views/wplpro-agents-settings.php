	...
	<div id="poststuff" class="metabox-holder has-right-sidebar">
		...
		<div id="post-body">
			<div id="post-body-content" class="has-sidebar-content">
				...
				<?php $options = get_option( 'wplpro_agents_settings' );
				...
				<form action="options.php" method="post" id="wplpro-agents-settings-options-form">
					...
					_e( '<p><label><input name="wplpro_agents_settings[wplpro_custom_wrapper]" id="wplpro_custom_wrapper" type="checkbox" value="1" class="code" ' . checked( 1, $options['wplpro_custom_wrapper'], false ) . ' /> Use Custom Wrapper?</p>', 'wplpro-agents' );
				    _e( '<p><label>Wrapper Start HTML: </p><input name="wplpro_agents_settings[wplpro_start_wrapper]" id="wplpro_start_wrapper" type="text" value="' . esc_html( $options['wplpro_start_wrapper'] ) . '" size="80" /></label>', 'wplpro-agents' );
				    _e( '<p><label>Wrapper End HTML: </p><input name="wplpro_agents_settings[wplpro_end_wrapper]" id="wplpro_end_wrapper" type="text" value="' . esc_html( $options['wplpro_end_wrapper'] ) . '" size="80" /></label><hr>', 'wplpro-agents' );


					_e( '<h3>Directory slug</h3><p>Optionally change the slug of the employee post type<br /><input type="text" name="wplpro_agents_settings[wplpro_slug]" value="' . $options['wplpro_slug'] . '" /></p>', 'wplpro-agents' );
