...
<table class="form-table">
	...
	<tr class="form-field">
		<th scope="row" valign="top"><label for="wp_listings_taxonomy[id]"><?php _e( 'ID', 'wp-listings-pro' ); ?></label></th>
		<td>
	...
	<tr class="form-field">
		...
		<p class="description"><?php _e( 'Example: "Property Types" or "Locations"', 'wp-listings-pro' ); ?></p></td>
	</tr>

	<tr class="form-field">
		<th scope="row" valign="top"><label for="wp_listings_taxonomy[singular_name]"><?php _e( 'Singular Name', 'wp-listings-pro' ); ?></label></th>
		...
		<p class="description"><?php _e( 'Example: "Property Type" or "Location"', 'wp-listings-pro' ); ?></p></td>
	</tr>
